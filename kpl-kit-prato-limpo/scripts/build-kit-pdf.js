...
async function buildPdf(variant, allFiles, blocksWithFiles, bonusesReady) {
  ...
  const desenhaUpgrade = () => {
    ...
    y -= 40;
    drawCentered(page, 'R$ 12,70', { font: bold, size: 40, color: COLOR.greenDark, y });
    y -= 24;
    drawCentered(page, 'No site, o Completo sai por R$ 29,90.', { font: regular, size: 10, color: COLOR.muted, y });
